...
{ 
    ...
    {
        $data[$idx]["taskID"] = (int)$row["TaskID"];
        $data[$idx]["listID"] = (int)$row["ListID"];
        $data[$idx]["taskName"] = $row["sTaskName"];
        $data[$idx]["isComplete"] = (int)$row["bComplete"] == 1 ? true : false;
        $data[$idx]["dateDue"] = $row["dDue"];
